from multi_doc_analyzer.reader.ace2005_reader.chineseParser.chinese_sgm_parser import *
from multi_doc_analyzer.reader.ace2005_reader.chineseParser.chinese_apf_xml_parser import *
import json
import glob
import os
...
def parse_source(data_path)-> Dict[str, Document]:
	doc_dicts = {}
...
if __name__ == '__main__':
	...
	parser.add_argument('--data_path', default='/Users/moju/work/resource/data/LDC2006T06/data/Chinese/')
	...
	print(str(doc_dicts["CTS20001211.1300.0012"].sentences[0].relation_mentions[0].arg1.char_b))
